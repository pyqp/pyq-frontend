  ...
  const pricingPlans = [
    {
      ...
      features: [
        { text: 'Access to 1 mock test', included: true },
    ...
    },
    {
      ...
      features: [
        { text: 'Access to 5 mock tests', included: true },
        ...
        { text: 'Valid for 90 days', included: true }
      ]
    },
    {
      id: 'max',
      ...
      features: [
        ...
        { text: 'Valid for 180 days', included: true }
      ]
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'When you purchase a package, you receive credits equal to the number of tests (1 credit = 1 mock test). You can use these credits on ANY mock test across ANY exam category. Credits don\'t expire within the validity period, and you can attempt each test unlimited times after unlocking it.'
    },
    {
      question: 'Can I use credits on different exams?',
      answer: 'Yes! Your credits are universal. You can buy the 5-test package and use 2 credits on SSC CGL, 2 on RRB NTPC, and 1 on Banking PO. Mix and match across all 50+ exams as you wish.'
    },
    {
      question: 'What happens after I unlock a test?',
      answer: 'Once you unlock a test using 1 credit, you can attempt it unlimited times within the validity period. You can review solutions, check your performance, and retake the test to improve your score - all without using additional credits.'
    },
    {
      question: 'Is the All India Ranking real?',
      answer: 'Yes! Your rank is calculated based on your score compared to all other students who have attempted that specific test. Rankings update in real-time as more students take the test.'
    },
    {
      question: 'What if I\'m not satisfied?',
      answer: 'We offer a 7-day money-back guarantee on all packages. If you\'re not satisfied with the quality of our mock tests, contact us within 7 days of purchase for a full refund - no questions asked.'
    },
    {
      question: 'Are the mock tests similar to actual exams?',
      answer: 'Our mock tests are designed by subject matter experts and closely follow the latest exam patterns, difficulty levels, and syllabus. They replicate the actual exam interface including timer, question types, and marking scheme.'
    },
    {
      question: 'Can I download the questions or solutions?',
      answer: 'You can view and practice questions online and review solutions within the platform. For offline study, we recommend taking screenshots or notes. The content is meant for online practice to ensure freshness and prevent sharing.'
    },
    {
      question: 'Do credits expire?',
      answer: 'Credits remain valid for the duration specified in your package (30/90/180 days from purchase date). After expiry, unused credits will be forfeited. However, tests already unlocked can be accessed until the end of the validity period.'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rank: 'AIR 89',
      avatar: '👨‍💼',
      quote: 'The 5-test package was perfect. I could practice across different sections and the analytics helped me improve my weak areas systematically.',
      rating: 5
    },
    {
      name: 'Priya Patel',
      ...
      rank: 'Selected',
      avatar: '👩‍💼',
      quote: 'Best investment for exam prep! The All India ranking feature kept me motivated and competitive. Got selected in first attempt.',
      rating: 5
    },
    {
      name: 'Rahul Kumar',
      ...
      rank: 'AIR 156',
      avatar: '👨‍🎓',
      quote: 'I bought the trial first, loved it, then upgraded to 10-test package. The unlimited attempts feature is a game-changer!',
      rating: 5
    }
  ];
      ...
      <div className="min-h-screen bg-[#FAFAFA] relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingPlans.map((plan) => (
              ...
              >
                ...
                <Link
                  to="/mock-tests"
                  className="block w-full py-4 font-black text-lg uppercase border-4 border-black transition-all duration-200 text-center hover:translate-x-1 hover:translate-y-1"
                  style={{
                ...
                {comparisonFeatures.map((category, catIdx) => (
                  <>
                    <tr key={`cat-${catIdx}`} className="bg-gray-100">
                      <td colSpan={4} className="p-4 font-black text-lg border-t-4 border-black">
                        {category.category}
                      </td>
                    </tr>
                    {category.features.map((feature, featIdx) => (
                      <tr key={`feat-${catIdx}-${featIdx}`} className="border-t-2 border-gray-300">
                        <td className="p-4 font-medium text-gray-700 border-r-2 border-gray-300">
                          {feature.name}
                        </td>
                        <td className="p-4 text-center border-r-2 border-gray-300">
                          {typeof feature.trial === 'boolean' ? (
                            ...
                            <span className="font-bold text-black">{feature.trial}</span>
                          )}
                        </td>
                        <td className="p-4 text-center border-r-2 border-gray-300 bg-orange-50">
                          {typeof feature.value === 'boolean' ? (
                            ...
                            <span className="font-bold text-black">{feature.value}</span>
                          )}
                        </td>
                        <td className="p-4 text-center">
                          {typeof feature.max === 'boolean' ? (
                            ...
                            <span className="font-bold text-black">{feature.max}</span>
                          )}
                        </td>
                      </tr>
                    ))}
              ...
              {[
                {
                  ...
                  description: 'Select the number of credits you need',
                  icon: Target,
                  color: '#2E5CFF'
                },
                {
                  ...
                  description: 'Pay safely via Razorpay gateway',
                  icon: Lock,
                  color: '#10B981'
                },
                {
                  step: '3',
                  title: 'Get Credits',
                  description: 'Credits added to your account instantly',
                  icon: Zap,
                  color: '#FF6B35'
                },
                {
                  ...
                  description: 'Use credits on any mock test you want',
                  icon: Trophy,
                  color: '#8B5CF6'
                }
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="relative bg-white border-4 border-black rounded-2xl p-6 hover:scale-105 transition-all duration-300 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
                >
                  <div 
                  ...
                  <div 
                    className="w-16 h-16 rounded-full flex items-center justify-center border-4 border-black mb-4 mx-auto"
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <div className="p-6 pt-0 text-gray-700 font-medium leading-relaxed">
                    {faq.answer}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 text-center">
            ...
            <Link 
              to="/about"
              className="inline-block px-8 py-4 bg-black text-white font-black uppercase border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all duration-200"
            >
              Contact Support
            </Link>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 border-4 border-black rounded-3xl p-12 md:p-16 text-center shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
              READY TO
              <br />
              <span className="text-yellow-400">START WINNING?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/mock-tests"
                className="inline-block px-10 py-5 bg-white text-black font-black text-xl rounded-none border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all duration-200 uppercase"
              >
                Choose Your Plan
              </Link>
              <Link 
                to="/free-pyqs"
                className="inline-block px-10 py-5 bg-black text-white font-black text-xl rounded-none border-4 border-white hover:bg-white hover:text-black transition-all duration-300 uppercase"
              >
                Try Free First
              </Link>
            </div>
