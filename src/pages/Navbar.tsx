...
const Navbar = () => {
  ...
  const resources = [
    { name: "Free PYQs", badge: "FREE", color: "#10B981" },
    { name: "Mock Tests", badge: "PAID", color: "#FF6B35" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-1">
                ...
                {activeDropdown === "exams" && (
                  <div className="absolute top-full left-0 mt-2 w-[600px] bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none">
                    ...
                    <div className="border-t-4 border-black bg-gray-50 p-4">
                      <button className="w-full py-3 bg-black text-white font-black text-sm uppercase hover:bg-gray-900 transition-colors">
                        View All 50+ Exams →
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="absolute top-full left-0 mt-2 w-72 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none">
                    <div className="p-4 space-y-2">
                      {resources.map((resource) => (
                        <div
                          key={resource.name}
                          className="p-3 border-2 border-black hover:bg-gray-50 cursor-pointer flex items-center justify-between group/item transition-all duration-200"
                        >
              ...
              {/* Regular Nav Items */}
              <Link to="/mock-tests" className="px-5 py-3 font-black text-sm uppercase tracking-tight hover:bg-black hover:text-white transition-all duration-200 border-2 border-transparent hover:border-black">
                Mock Tests
              </Link>
              <Link to="/about" className="px-5 py-3 font-black text-sm uppercase tracking-tight hover:bg-black hover:text-white transition-all duration-200 border-2 border-transparent hover:border-black">
                About
              </Link>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Sign Up Button */}
              <Link to="/signup" className="hidden md:flex items-center gap-2 px-6 py-3 bg-black text-white font-black text-sm uppercase border-4 border-black hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 transition-all duration-300">
                Sign Up
              </Link>
              {/* Mobile Menu Button */}
              <button
          ...
          <div className="p-4 border-b-4 border-black">
            ...
            <div className="space-y-2">
              {resources.map((resource) => (
                <div
                  key={resource.name}
                  className="p-4 border-2 border-black hover:bg-gray-50 cursor-pointer flex items-center justify-between"
                >
